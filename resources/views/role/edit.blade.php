                ...
                <form class="layui-form" lay-filter="component-form-group">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="name" lay-verify="required" placeholder="请输入名称" class="layui-input" value="{{ $data->name }}">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">标识</label>
                        <div class="layui-input-block">
                            <input type="text" name="code" lay-verify="required" placeholder="请输入标识" class="layui-input" value="{{ $data->code }}">
                        </div>
                    </div>
                    <div class="layui-form-item" id="add-line-box">
                        ...
                        <div class="layui-input-block layui-col-space10">
                            <div class="layui-col-md2">
                                <select name="method[]" >
                                    <option @if($rule['method'] == "ALL") selected @endif>ALL</option>
                                    <option @if($rule['method'] == "GET") selected @endif>GET</option>
                                    <option @if($rule['method'] == "POST") selected @endif>POST</option>
                                    <option @if($rule['method'] == "PUT") selected @endif>PUT</option>
                                    <option @if($rule['method'] == "DELETE") selected @endif>DELETE</option>
                                </select>
                            </div>
                            @if($loop->first)
                            <div class="layui-col-md7">
                                <input type="text" name="url[]" placeholder="链接地址" class="layui-input" value="{{ $rule['url'] }}">
                            </div>
