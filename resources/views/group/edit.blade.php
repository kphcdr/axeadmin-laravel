            ...
            <div class="layui-card-body" style="padding: 15px;">
                <form class="layui-form" lay-filter="component-form-group">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="desc" placeholder="请输入描述" class="layui-input" value="{{ $data->desc }}">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            @foreach(\Axe\Models\Role::getAllName() as $id=>$name)
                                <input type="checkbox" name="roles[]" @if(in_array($id,$data->getRoleIdArr())) checked @endif title="{{ $name }}" value="{{ $id }}">
                            @endforeach
                        </div>
                    </div>
                    <div class="layui-form-item">
